    ...
    <div className="min-h-screen bg-surface-base py-space-12">
      <div className="content-width">
        ...
        <p className="font-body text-body text-text-muted mb-space-12">
          Complete showcase of every card component with all available variants
          and states.
        </p>
        ...
        <DemoSection title="AchievementCard – Archive Post & Ticker Item">
          ...
          <AchievementCard
            ...
            year="2026"
            category="Academics"
            context="Highest in Kalutara District – 95% pass rate."
          />
          <div className="flex flex-col gap-space-4">
            <AchievementCard
              variant="ticker-item"
              title="Gold Medal – Science Exhibition"
              year="2025"
              category="Science"
            />
            <AchievementCard
        ...
        <DemoSection title="DownloadableDocumentItem">
          <DownloadableDocumentItem
            ...
            description="Grade 1 admissions application – fill and submit"
          />
          <DownloadableDocumentItem
            title="Annual Sports Meet Schedule"
            fileType="doc"
            fileSize="1.1 MB"
            url="/documents/sports-schedule.doc"
          />
        </DemoSection>
        ...
        <DemoSection title="EventCard – Standard">
          ...
          <EventCard
            ...
            category="Academics"
            status="past"
            href="/events/science-exhibition-2025"
          />
        </DemoSection>
        ...
        <DemoSection title="EventCard – Featured">
          <EventCard
            ...
            category="Technology"
            status="registration-open"
            href="/events/nexus-launch"
            imageSrc="/images/white.jpg"
            registrationHref="/events/nexus-launch/register"
            relativeTime="Starts in 2 weeks"
          />
        </DemoSection>
        ...
        <DemoSection title="ExtracurricularCard – Sport">
          <ExtracurricularCard
            variant="sport"
            name="Cricket Team"
            description="The Men in Green – Kalutara District champions 2025."
            recentAchievements={[
              'District Champions 2025',
              'Pasdun Cup Winners 2024',
            ]}
            teacherInCharge="Mr. Silva"
            season="Current Season: 2026"
            imageSrc="/images/white.jpg"
            href="/extracurriculars/cricket"
          />
        </DemoSection>
        ...
        <DemoSection title="ExtracurricularCard – Performing Arts">
          <ExtracurricularCard
            ...
            name="Western Band"
            description="Performing at all major school events and competitions."
            studentQuote="Music is our second language."
            teacherInCharge="Mrs. Perera"
            imageSrc="/images/white.jpg"
            href="/extracurriculars/western-band"
          />
        </DemoSection>
        ...
        <DemoSection title="ExtracurricularCard – Leadership">
          <ExtracurricularCard
            variant="leadership"
            name="Scout Troop"
            description="Founded 1952 – 35+ President's Scout Award winners."
            recentAchievements={[
              "President's Scout – 2025",
              'Best Troop – Kalutara District',
            ]}
            teacherInCharge="Mr. Jayawardena"
            href="/extracurriculars/scouts"
          />
        </DemoSection>
        ...
        <DemoSection title="FacilityCard – Standard">
          ...
          <FacilityCard
            name="Library"
            description="Over 10,000 books and digital resources."
            features={['Reading hall', 'E-library', 'Periodicals section']}
        ...
        <DemoSection title="GalleryAlbumCard">
          ...
          <GalleryAlbumCard
            ...
            photoCount={28}
            category="Academics"
            href="/gallery/science-exhibition-2024"
          />
          <GalleryAlbumCard
            title="Big Match 2026"
            year="2026"
            photoCount={56}
            category="Sports"
            href="/gallery/big-match-2026"
          />
        </DemoSection>
        ...
        <DemoSection title="NewsCard – Featured">
          <NewsCard
            variant="featured"
            title="KCC Tops Kalutara District Again with 214 University Entrances"
            excerpt="The highest number of university placements in the district, with a 95% pass rate at A/L examinations."
            category="Academics"
            date="May 2026"
            href="/news/results-2026"
            imageSrc="/images/white.jpg"
          />
        </DemoSection>
        ...
        <DemoSection title="NewsCard – Standard">
          <NewsCard
            ...
            excerpt="The official school website built entirely by students under the guidance of KITS."
            category="Technology"
            date="April 2026"
          ...
          <NewsCard
            variant="standard"
            title="Cadet Corps Annual Camp"
            excerpt="Students participated in the Rantambe training camp with great success."
            category="Extracurricular"
            date="March 2026"
            href="/news/cadet-camp"
          />
        </DemoSection>
        ...
        <DemoSection title="NewsCard – Compact">
          <div className="w-96">
            <NewsCard
              variant="compact"
              title="Swimming Pool Reopens After Renovation"
              category="Facilities"
              date="Jun 1, 2026"
              href="/news/pool-reopens"
            />
            <NewsCard
              variant="compact"
              title="Alumni Reunion 2026 – Save the Date"
              category="Alumni"
              date="May 28, 2026"
              href="/news/alumni-reunion"
            />
            <NewsCard
              variant="compact"
              title="Scholarship Exam Results Announced"
              category="Academics"
              date="May 20, 2026"
              href="/news/scholarship-results"
            />
          </div>
        </DemoSection>
        ...
        <DemoSection title="SocietyBanner">
          <SocietyBanner
            ...
            foundingYear={2010}
            coverImageSrc="/images/white.jpg"
          />
        ...
        <DemoSection title="SocietyCard – Hub Grid">
          <SocietyCard
            ...
            tagline="Exploring the wonders of science through experiments and field trips."
            category="Academic"
          ...
          <SocietyCard
            variant="hub-grid"
            name="Drama Club"
            tagline="Annual stage plays and cultural performances."
            category="Performing Arts"
            href="/societies/drama"
            memberCount={35}
            founded="1980"
          />
          <SocietyCard
            variant="hub-grid"
            name="Sports Council"
            tagline="Organizing inter-house and district-level competitions."
            category="Sports"
        ...
        <DemoSection title="SocietyCard – Featured (KITS)">
          <SocietyCard
            variant="featured"
            name="KITS – Kannangara ICT Society"
            tagline="Building the digital future of KCC. Creators of Nexus and Paideon."
            category="Technology"
            href="/societies/kits"
            memberCount={120}
            founded="2010"
        ...
        <DemoSection title="StaffCard – Principal">
          <StaffCard
            ...
            title="Principal"
            tenure="Since 2019"
            quote="Education is not a privilege – it is the birthright of every child who walks through these gates."
            imageSrc="/images/white.jpg"
            href="/administration"
          />
        </DemoSection>
        ...
        <DemoSection title="StaffCard – Grid">
          ...
          <StaffCard
            variant="grid"
            name="Mr. Nimal Jayasuriya"
            title="Head of Science"
            portfolio="Physics Department"
            tenure="10 years"
          />
          <StaffCard
            variant="grid"
            name="Ms. Dilani Fernando"
            title="Teacher in Charge – KITS"
            portfolio="ICT & Computing"
          />
        </DemoSection>
        ...
        <DemoSection title="StatCard – Single Metric">
          ...
          <StatCard
            value={200}
            suffix="+"
            label="University Entrances (2025)"
          />
        </DemoSection>
