    ...
    <div className="min-h-screen bg-surface-base py-12">
      <div className="content-width">
        ...
        <p className="font-body text-body text-text-muted mb-12">
          Site‑wide elements like banners, animations, maps and the language
          switcher.
        </p>
        ...
        <DemoSection title="AnnouncementBanner">
          ...
          <AnnouncementBanner variant="warning">
        ...
        <DemoSection title="MapEmbed">
          <MapEmbed
            src="https://www.openstreetmap.org/export/embed.html?bbox=80.0%2C6.0%2C80.1%2C6.1&layer=mapnik"
            title="KCC Location"
          />
        </DemoSection>
        ...
        <DemoSection title="MasonryGrid">
          <MasonryGrid columnCount={{ mobile: 2, tablet: 3, desktop: 4 }}>
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className="bg-surface-elevated border border-border-light p-4 text-center"
              >
                Item {i}
              </div>
            ))}
        ...
        <DemoSection title="ScrollProgressBar">
          <ScrollProgressBar />
          <p className="text-sm text-text-muted">
            (Scroll down to see the progress bar at the top of the page)
          </p>
        </DemoSection>
      </div>
    </div>
