  ...
  return (
    <div>
      ...
      <p className="font-body text-body text-text-muted mb-space-4">
        Four blur steps for decorative glows, loading states, and image effects.{' '}
        <strong>Never</strong> use these for glass panels — glass uses{' '}
      ...
      <p className="font-body text-body-sm text-text-muted mb-space-12">
        Note: token values are raw lengths (e.g.{' '}
        <code className="font-mono text-code bg-surface-default px-space-2 py-space-1 rounded-sm">
          4px
        </code>
        ), so consume them as{' '}
            ...
            <div className="relative w-size-40 h-size-40 rounded-md overflow-hidden">
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    'linear-gradient(135deg, var(--color-green-base) 50%, var(--color-gold-base) 50%)',
                }}
              />
