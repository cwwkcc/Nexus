    ...
    <div className="min-h-screen bg-surface-base py-space-12">
      <div className="content-width">
        ...
        <p className="font-body text-body text-text-muted mb-space-12">
          Floating UI elements – drawers, dropdowns, share sheets, and tooltips.
        </p>
        ...
        <DemoSection title="Drawer">
          ...
          >
            <div className="p-space-6">
              <h3 className="font-display text-h3 mb-space-4">
                Drawer Content
              </h3>
              <p className="font-body text-body text-text-muted">
                This is a slide‑in panel. Click outside or press Escape to
                close.
              </p>
              <Button
          ...
          <div className="mt-space-4">
            <p className="font-body text-caption text-text-muted">
              Persistent sidebar variant (for admin) also available via{' '}
              <code>persistent</code> prop.
            </p>
          </div>
        </DemoSection>
        ...
        <DemoSection title="DropdownMenu">
          <div className="flex gap-space-8 flex-wrap">
            <DropdownMenu
              trigger={<Button variant="secondary">Navigation Dropdown</Button>}
              items={dropdownItems}
              variant="navigation"
            />
            <DropdownMenu
