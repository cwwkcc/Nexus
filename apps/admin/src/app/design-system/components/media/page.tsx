    ...
    <div className="min-h-screen bg-surface-base py-space-12">
      <div className="content-width">
        ...
        <DemoSection title="ImageFrame – Variants & Ratios">
          <ImageFrame src="/images/white.jpg" alt="Standard 16:9" aspectRatio="16/9" variant="standard" className="w-64" />
          <ImageFrame src="/images/white.jpg" alt="Featured with overlay" aspectRatio="4/3" variant="featured" overlay="medium" className="w-64" />
          <ImageFrame src="/images/white.jpg" alt="Full bleed" aspectRatio="21/9" variant="full-bleed" className="w-80" />
          <ImageFrame src="/images/white.jpg" alt="Portrait" aspectRatio="3/4" className="w-48" />
        </DemoSection>

        <DemoSection title="ImageFrame – With Caption & Corner Badge">
          <ImageFrame src="/images/white.jpg" alt="With caption" aspectRatio="16/9" caption="Main building, completed in 1965" className="w-80" />
          <ImageFrame src="/images/white.jpg" alt="With badge" aspectRatio="16/9" cornerBadge={<span className="bg-gold-base text-green-base px-space-2 py-space-0.5 text-caption rounded">Featured</span>} className="w-80" />
        </DemoSection>

        {/* VideoFrame */}
        <DemoSection title="VideoFrame – YouTube Embed">
          <VideoFrame src="https://www.youtube.com/watch?v=dQw4w9WgXcQ" source="youtube" title="Sample YouTube video" aspectRatio="16/9" className="w-96" />
        </DemoSection>

        <DemoSection title="VideoFrame – Direct MP4 with Poster">
          <VideoFrame src="/videos/sample.mp4" source="direct" posterSrc="/images/white.jpg" title="School promotional video" aspectRatio="16/9" className="w-96" />
        </DemoSection>
          ...
          <div className="flex gap-space-4">
            {demoImages.map((img, idx) => (
              <button key={idx} onClick={() => openLightbox(idx)} className="cursor-pointer">
                <ImageFrame src={img.src} alt={img.alt} aspectRatio="4/3" className="w-32 transition-opacity hover:opacity-80" />
              </button>
            ))}
          </div>
        ...
        <DemoSection title="PanoramicFacilityViewer">
          <PanoramicFacilityViewer images={panoramicImages} defaultIndex={0} className="w-full max-w-2xl" />
        </DemoSection>
