    ...
    <div className="min-h-screen bg-surface-base py-space-12">
      <div className="content-width">
        ...
        <p className="font-body text-body text-text-muted mb-space-12">
          Global system components – banners, empty/error states, loading
          screens, cookie consent, offline banners, and the 404 page.
        </p>

        {/* Announcement Banner */}
        <DemoSection
          title="AnnouncementBanner"
          description="Dismissible top‑of‑page announcement strip for urgent notices."
        >
          <div className="space-y-space-4">
            ...
            <AnnouncementBanner variant="error">
              Website maintenance scheduled for Sunday 2 AM – 4 AM.
            </AnnouncementBanner>
          </div>
        </DemoSection>
        ...
        <DemoSection
          ...
          description="Appears at the bottom of the page if consent not given. Uses localStorage to remember preference."
        >
          <div className="p-space-6 bg-surface-elevated border border-border-light rounded-md">
            <p className="font-body text-body-sm text-text-muted mb-space-4">
              The banner is fixed to the viewport. Scroll down to see it appear
            ...
            <p className="font-body text-caption text-text-muted mt-space-4">
              ...
              <code className="bg-surface-deep px-space-1 rounded-sm">
                localStorage.removeItem('kcc-cookie-consent')
              </code>
              )
            </p>
          </div>
        ...
        <DemoSection
          title="EmptyState"
          description="Displayed when no data is available (e.g., empty search results, no news)."
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-space-6">
            <div className="border border-border-light rounded-md overflow-hidden">
              <EmptyState
                heading="No news found"
                description="There are no articles matching your criteria. Try adjusting your filters."
              />
            </div>
            <div className="border border-border-light rounded-md overflow-hidden">
              <EmptyState
        ...
        <DemoSection
          title="ErrorState"
          description="Displayed when something goes wrong – inline or full section variants."
        >
          <div className="space-y-space-6">
            ...
            <div>
              ...
              <ErrorState
                variant="section"
                message="Unable to load content. Check your connection and refresh."
        ...
        <DemoSection
          title="LoadingScreen"
          description="Full‑viewport loading overlay with animated crest. Used for page transitions and initial load."
        >
        ...
        <DemoSection
          ...
          description="Shimmer placeholders for content loading. Variants: card, table-row, section."
        >
          <div className="space-y-space-8">
            <div>
              <p className="font-body text-label mb-space-2">
                Card grid (default)
              </p>
        ...
        <DemoSection
          title="OfflineBanner"
          description="Shows a banner at the top when the user loses network connection."
        >
          <div className="p-space-6 bg-surface-elevated border border-border-light rounded-md">
            <p className="font-body text-body-sm text-text-muted mb-space-4">
              Simulate offline mode in DevTools (Network tab → "Offline") to see
              the banner appear at the top of the page.
            </p>
            <OfflineBanner />
          </div>
        </DemoSection>
        ...
        {/* 404 Page Preview */}
        <DemoSection
          title="NotFoundPage (404)"
          description="Full‑page 404 component with animated count‑up and quick navigation links."
        >
