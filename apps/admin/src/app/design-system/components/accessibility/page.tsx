    ...
    <div className="min-h-screen bg-surface-base py-space-12">
      <div className="content-width">
        ...
        <p className="font-body text-body text-text-muted mb-space-12">
          Components and patterns that enhance accessibility – focus management,
        ...
        <DemoSection title="Focus Ring (Keyboard Only)">
          <p className="font-body text-body-sm text-text-muted mb-space-4">
            ...
            to navigate and see the gold focus ring.
          </p>
          ...
          <p className="font-body text-caption text-text-muted mt-space-4">
            Focus rings are built with CSS custom properties:{' '}
            <code>var(--focus-ring-color)</code>,{' '}
            <code>var(--focus-ring-width)</code>,{' '}
            <code>var(--focus-ring-offset)</code>.
          </p>
        </DemoSection>
        ...
        <DemoSection title="Screen Reader Only Text">
          <div className="bg-surface-default p-space-6 rounded-md">
            <p className="font-body text-body text-text-primary">
              ...
              <Button
                variant="primary"
                aria-label="More information about accessibility"
              >
        ...
        <DemoSection title="Keyboard Navigation Patterns">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-space-8">
            <div className="bg-surface-elevated border border-border-light rounded-md p-space-5">
              <h3 className="font-display text-h3 mb-space-3">
                Modal Keyboard Trap
              </h3>
              <p className="font-body text-body-sm text-text-muted mb-space-4">
                Open a modal and press <kbd>Tab</kbd> – focus stays inside the
                modal. Press <kbd>Escape</kbd> to close.
              </p>
              <Button
                variant="secondary"
                onClick={() => {
            ...
            <div className="bg-surface-elevated border border-border-light rounded-md p-space-5">
              ...
              <p className="font-body text-body-sm text-text-muted mb-space-4">
                Dynamic updates announced to screen readers automatically.
              </p>
              <div
                aria-live="polite"
                className="bg-surface-deep p-space-3 rounded-sm"
              >
        ...
        <DemoSection title="Touch Targets (≥44×44px)">
          ...
          <p className="font-body text-caption text-text-muted mt-space-4">
            All interactive elements meet WCAG 2.2 minimum touch target size.
          </p>
        </DemoSection>
        ...
        <DemoSection title="Skip to Content">
          <div className="bg-surface-elevated border border-border-light rounded-md p-space-5">
            <a
              href="#main-content"
              className="sr-only focus:not-sr-only focus:absolute focus:top-space-4 focus:left-space-4 focus:z-modal focus:bg-gold-base focus:text-green-base focus:p-space-3 focus:rounded-md"
            >
              Skip to main content
            </a>
            <p className="font-body text-body-sm text-text-muted">
              Press <kbd>Tab</kbd> immediately after page load – a "Skip to main
              content" link appears.
            </p>
          </div>
        </DemoSection>
        ...
        <DemoSection title="Reduced Motion Awareness">
          <div className="bg-surface-elevated border border-border-light rounded-md p-space-5">
            <p className="font-body text-body-sm text-text-muted">
              All components respect <code>prefers-reduced-motion</code>.
