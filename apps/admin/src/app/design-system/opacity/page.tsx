...
export default function OpacityPage() {
  return (
    <div>
      ...
      <p className="font-body text-body text-text-muted mb-space-12">Opacity scale for overlays, disabled states, and fading effects.</p>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-6">
        {opacityTokens.map((token) => (
          <div key={token} className="flex items-center gap-space-4 p-space-4 border border-border-light rounded-md">
            <div className="w-size-16 h-size-16 bg-gold-base rounded-sm shrink-0" style={{ opacity: `var(--${token})` }} />
            <div>
