// packages/contracts/src/registry/pages/home.ts
//
// Page registry for: Home
//
// Should contain:
//   homeRegistry — PageRegistry object:
//     page:        'home'
//     scope:       'page:home'
//     label:       'Home'
...
//   key:         'home.{sectionName}'  → stored as ContentEntry.sectionKey
...
//   2. Add seed data in packages/database/prisma/seed-home.ts
//   3. Update the page fetcher in apps/web/src/server/content.ts
//   4. Build the block in apps/web/src/blocks/home/
