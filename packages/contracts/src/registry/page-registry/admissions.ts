// packages/contracts/src/registry/pages/admissions.ts
//
// Page registry for: Admissions
//
// Should contain:
//   admissionsRegistry — PageRegistry object:
//     page:        'admissions'
...
//   key:         'admissions.{sectionName}'  → stored as ContentEntry.sectionKey
...
//   2. Add seed data in packages/database/prisma/seed-admissions.ts
//   3. Update the page fetcher in apps/web/src/server/content.ts
//   4. Build the block in apps/web/src/blocks/admissions/
