...
export const galleryRegistry: PageRegistry = {
  ...
  scope: 'page:gallery',
  label: 'Gallery',
  description: 'Manage the Gallery page hero and the optional video section. The albums grid is populated automatically from the Gallery module — manage those under Gallery, not here.',
  sections: [
    {
      key: 'gallery.hero',
      blockKey: 'hero',
