...
export const eventsRegistry: PageRegistry = {
  ...
  scope: 'page:events',
  label: 'Events',
  description: 'Manage the Events page hero. The calendar grid and event list are populated automatically from the school calendar — manage those under the Events module, not here.',
  sections: [
    {
      key: 'events.hero',
      blockKey: 'hero',
