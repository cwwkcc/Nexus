...
export const facilitiesRegistry: PageRegistry = {
  ...
  label: 'Facilities',
  description: 'The Facilities page showcases KCC campus infrastructure — classrooms, laboratories, libraries, sports facilities, and student amenities.',
  sections: [
    {
      key: 'facilities.hero',
      blockKey: 'hero',
      label: 'Hero Banner',
      description: 'Eyebrow text (e.g. "Campus Infrastructure"), page headline, optional emphasised word, and subtitle shown at the top of the page.',
    ...
    },
    {
      ...
      blockKey: 'stats',
      label: 'Stats Strip',
      description: 'The counter strip below the hero (classrooms, labs, etc). Each stat has a target number, label, and optional prefix/suffix.',
    ...
    },
    {
      ...
      description: 'One card per facility (Main Building, Science Labs, ICT Labs, Auditorium, Sports Grounds, Swimming Pool, Library). The Swimming Pool is the only one with a schedule.',
    ...
    },
    {
      ...
      description: 'Bottom section with heading, subtitle, and button(s) to encourage visits or contact.',
