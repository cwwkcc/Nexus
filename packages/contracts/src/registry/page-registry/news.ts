...
export const newsRegistry: PageRegistry = {
  ...
  description: 'Manage the News page hero and announcement banner. The featured article and news feed are populated automatically from published articles — manage those under the News module, not here.',
  sections: [
    {
      key: 'news.hero',
      blockKey: 'hero',
