 ...
 */
export const STAFF_ROLE_HIERARCHY: readonly StaffRoleEnumData[] = ['principal', 'deputy-principal', 'assistant-principal', 'head-prefect', 'teacher', 'support'];
 ...
 * `imageSrc`/`imageAlt` props StaffCard (@nexus/ui) actually reads.
 *
 ...
 */
export function toStaffCardData(staff: StaffData, overrides: Partial<Pick<StaffCardData, 'href'>> = {}): StaffCardData {
  return {
    id: staff.id,
    name: staff.name,
    role: staff.role,
