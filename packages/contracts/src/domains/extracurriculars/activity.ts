...
// explanation of why). What survives here is only what @nexus/ui's
...
export const EXTRACURRICULAR_CATEGORY_META: ExtracurricularCategoryMeta[] = Object.entries(EXTRACURRICULAR_CATEGORIES).map(([key, label]) => ({
