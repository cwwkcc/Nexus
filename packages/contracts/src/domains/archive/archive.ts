...
export const ArchiveCategory = z.enum(['photograph', 'magazine', 'prize_giving_record', 'prefect_list']);

// Display labels for UI components
export const ARCHIVE_CATEGORY_LABELS: Record<z.infer<typeof ArchiveCategory>, string> = {
