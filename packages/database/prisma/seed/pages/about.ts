  ...
  alumni: {
    ...
    profiles: [
      ...
      },
      {
        ...
        currentOrg: 'National Water Board',
        quote: 'The discipline I learned at KCC still guides every project I take on.',
      },
      {
        id: 'alum-3',
        name: 'Mrs. N. Fernando',
        graduationYear: '1998',
        currentRole: 'District Secretary',
        quote: 'Free education gave me a start; service to the district is how I pay it forward.',
      },
      {
        id: 'alum-4',
        ...
        graduationYear: '2012',
        currentRole: 'Founder',
        currentOrg: 'Mathugama AgriTech',
        quote: 'KCC taught me that ideas mean nothing without service to the community around them.',
        portrait: {
          src: '/assets/images/ironman.jpg',
          alt: 'Mr. R. Jayasuriya',
        },
      ...
      {
        id: 'alum-5',
        name: 'Ms. T. Wickramasinghe',
        graduationYear: '2018',
        currentRole: 'Violinist',
        currentOrg: 'Symphony Orchestra of Sri Lanka',
        quote: "The school choir is where I first learned that discipline and joy aren't opposites.",
      },
    ],
  },
  legacy: {
    ...
    profiles: [
      {
        ...
        portrait: {
          src: '/assets/images/ironman.jpg',
          alt: 'මිස්ටර් ආර්. ජයසූරිය',
        },
      },
      {
        id: 'alum-2',
        name: 'ඉංජි. එස්. පෙරේරා',
        graduationYear: '2005',
        currentRole: 'සිවිල් ඉංජිනේරු',
        currentOrg: 'ජාතික ජල සම්පාදන මණ්ඩලය',
        quote: 'කේ.සී.සී.හිදී මා ඉගෙන ගත් විනයගරුක බව අදත් සෑම ව්‍යාපෘතියකදීම මා මඟ පෙන්වයි.',
      },
      {
        id: 'alum-3',
        name: 'මිසිස් එන්. ප්‍රනාන්දු',
        graduationYear: '1998',
        currentRole: 'දිස්ත්‍රික් ලේකම්',
        quote: 'නිදහස් අධ්‍යාපනය මට ආරම්භයක් ලබා දුන්නා; දිස්ත්‍රික්කයට සේවය කිරීම මගින් මම එය ආපසු ලබා දෙනවා.',
      },
      {
        id: 'alum-4',
        name: 'මිස්ටර් ආර්. ජයසූරිය',
        graduationYear: '2012',
        currentRole: 'නිර්මාතෘ',
        currentOrg: 'මතුගම ඇග්‍රිටෙක්',
        quote: 'අදහස් වටා ඇති ප්‍රජාවට සේවය නොකළොත් එයට කිසිම වටිනාකමක් නැති බව කේ.සී.සී. මට ඉගැන්නුවා.',
        portrait: {
          src: '/assets/images/ironman.jpg',
          alt: 'මිස්ටර් ආර්. ජයසූරිය',
        },
      ...
      {
        id: 'alum-5',
        name: 'මිස් ටී. වික්‍රමසිංහ',
        graduationYear: '2018',
        currentRole: 'වයලින් වාදකයෙක්',
        currentOrg: 'ශ්‍රී ලංකා සංධ්වනි වාද්‍ය වෘන්දය',
        quote: 'විනය සහ ප්‍රීතිය එකිනෙකට විරුද්ධ නොවන බව මම මුලින්ම ඉගෙන ගත්තේ පාසැල් ගායක මණ්ඩලයෙනුයි.',
      },
    ],
  },
  legacy: {
...
const ABOUT_SEED_TA: AboutPageSeed = {
  ...
  alumni: {
    ...
    profiles: [
      ...
      {
        id: 'alum-2',
        name: 'பொறி. எஸ். பெரேரா',
        graduationYear: '2005',
        currentRole: 'சிவில் பொறியாளர்',
        currentOrg: 'தேசிய நீர்வழங்கல் வாரியம்',
        quote: 'KCC-இல் நான் கற்றுக்கொண்ட ஒழுக்கம் இன்றும் ஒவ்வொரு திட்டத்திலும் என்னை வழிநடத்துகிறது.',
      },
      {
        id: 'alum-3',
        name: 'திருமதி என். பெர்னாண்டோ',
        graduationYear: '1998',
        currentRole: 'மாவட்ட செயலாளர்',
        quote: 'இலவசக் கல்வி எனக்கு ஒரு தொடக்கத்தைத் தந்தது; மாவட்டத்திற்குச் சேவை செய்வதே அதை நான் திருப்பிச் செலுத்தும் வழி.',
      },
      {
        id: 'alum-4',
        name: 'திரு. ஆர். ஜயசூரிய',
        graduationYear: '2012',
        currentRole: 'நிறுவனர்',
        currentOrg: 'மதுகம அக்ரிடெக்',
        quote: 'சுற்றியுள்ள சமூகத்திற்கு சேவை செய்யாவிட்டால் யோசனைகளுக்கு எந்த மதிப்பும் இல்லை என்பதை KCC எனக்குக் கற்பித்தது.',
        portrait: {
          src: '/assets/images/ironman.jpg',
          alt: 'திரு. ஆர். ஜயசூரிய',
        },
      },
      {
        id: 'alum-5',
        name: 'செல்வி டி. விக்ரமசிங்க',
        graduationYear: '2018',
        currentRole: 'வயலின் கலைஞர்',
        currentOrg: 'இலங்கை சிம்பொனி இசைக்குழு',
        quote: 'ஒழுக்கமும் மகிழ்ச்சியும் எதிரானவை அல்ல என்பதை நான் முதலில் கற்றுக்கொண்டது பள்ளி பாடகர் குழுவில்தான்.',
      },
    ],
  },
  legacy: {
