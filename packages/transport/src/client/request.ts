...
export function buildUrl(path: string, config?: Pick<RequestConfig, 'baseUrl' | 'query'>): string {
...
export function buildInit(method: string, body: unknown, config?: RequestConfig): RequestInit {
...
function isBodyInit(value: unknown): value is BodyInit {
  return typeof value === 'string' || value instanceof FormData || value instanceof URLSearchParams || value instanceof Blob || value instanceof ArrayBuffer;
}
