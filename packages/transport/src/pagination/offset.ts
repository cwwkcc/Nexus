...
export function parseOffsetParams(query: Record<string, unknown>, defaultPageSize = 20): OffsetPageParams {
...
export function createOffsetPage<T>(items: T[], total: number, params: OffsetPageParams): OffsetPage<T> {
  return {
    items,
    page: params.page,
