...
export function LanguageSwitcher({ locale = 'en', variant = 'header', onDark = false, languages = DEFAULT_LANGUAGES, getSwitchLabel = (name: string) => `Switch to ${name}` }: LanguageSwitcherProps) {
