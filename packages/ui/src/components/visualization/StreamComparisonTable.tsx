...
export function StreamComparisonTable({ streams, className }: StreamComparisonTableProps) {
        ...
        {streams.map((stream) => (
          <div key={stream.id} className="bg-surface-elevated border border-border-light rounded-lg p-space-6">
            ...
            <div className="mb-space-4">
              <p className="font-body text-label uppercase tracking-wider text-text-muted mb-space-2">Subjects</p>
            ...
            <div className="mb-space-4">
              <p className="font-body text-label uppercase tracking-wider text-text-muted mb-space-2">Career Paths</p>
              <ul className="list-disc pl-space-5 space-y-space-1">
            ...
            <div className="mb-space-4">
              <p className="font-body text-label uppercase tracking-wider text-text-muted mb-space-2">Entry Requirements</p>
              <p className="font-body text-body-sm text-text-primary">{stream.entryRequirements}</p>
            </div>
            <div>
              <p className="font-body text-label uppercase tracking-wider text-text-muted mb-space-2">Pass Rate</p>
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b-2 border-border-default">
            <th className="text-left p-space-4 font-body text-label uppercase tracking-wider text-text-muted">Stream</th>
            {streams.map((stream) => (
        ...
        <tbody>
          <tr className="border-b border-border-light">
            <td className="p-space-4 font-body text-label uppercase tracking-wider text-text-muted bg-surface-deep">Subjects</td>
            {streams.map((stream) => (
          ...
          <tr className="border-b border-border-light">
            <td className="p-space-4 font-body text-label uppercase tracking-wider text-text-muted bg-surface-deep">Career Paths</td>
            {streams.map((stream) => (
              <td key={stream.id} className="p-space-4 align-top">
                <ul className="list-disc pl-space-4 space-y-space-1">
                  {stream.careerPaths.map((c) => (
          ...
          <tr className="border-b border-border-light">
            <td className="p-space-4 font-body text-label uppercase tracking-wider text-text-muted bg-surface-deep">Entry Requirements</td>
            {streams.map((stream) => (
          ...
          <tr>
            <td className="p-space-4 font-body text-label uppercase tracking-wider text-text-muted bg-surface-deep">Pass Rate</td>
            {streams.map((stream) => (
