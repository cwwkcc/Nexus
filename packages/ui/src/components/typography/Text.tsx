import { type ElementType, type ComponentPropsWithoutRef, type Ref } from 'react';

import { cn } from '../../utilities/cn';

type TextVariant = 'body' | 'body-sm' | 'caption' | 'label' | 'label-sm';
type TextAlign = 'left' | 'center' | 'right';
type TextColor = 'primary' | 'muted' | 'inverse' | 'gold' | 'success' | 'error' | 'warning' | 'info';
...
export const Text = ({ variant = 'body', color = 'primary', as: Tag = 'p', align, className, children, ref, ...rest }: TextProps) => {
  return (
