...
export const WhatsAppGlyphBlack = forwardRef<SVGSVGElement, SocialIconProps>(({ size = 'md', color: _color, className, style, ...props }, ref) => {
  ...
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 720" aria-hidden="true" focusable="false" className={cn(sizeClass, className)} style={customStyle} {...props}>
      <defs>
        <style
