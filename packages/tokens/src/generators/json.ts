...
import { blur, opacity, aspectRatio, zIndex, backgroundImage, scale } from '../primitives/effects.ts';
import { transitionDuration, transitionTimingFunction } from '../primitives/motion.ts';
