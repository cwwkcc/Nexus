...
| 2.9 | Alumni testimonial – written statement | Alumni (individual) | 2–4 sentences; written consent required per person | ⬜ |
...
| 4.4 | Notable academic achievements | Administration | e.g. island ranks, batch results (with publication consent) | ⬜ |
...
## Section 6: Societies & Extracurriculars

*One record required per society/club.*

| # | Asset | Owner | Notes | Status |
|---|-------|-------|-------|--------|
| 6.1 | Society name and description | Teacher-in-Charge (per society) | 50–150 words per society | ⬜ |
| 6.2 | Society logo or emblem | Society / KITS | PNG with transparent background preferred | ⬜ |
| 6.3 | Society leader(s) name and class | Society Prefects | President, Secretary, or equivalent | ⬜ |
| 6.4 | Teacher-in-charge name | Administration | Per society | ⬜ |
| 6.5 | Society activity photographs (3–6 per society) | Media Unit / Society | Meetings, events, competitions | ⬜ |
| 6.6 | Notable recent achievements | Society / Teacher-in-Charge | Competitions, events organised | ⬜ |

*Known societies: KITS, Science Society, Scouts, Girl Guides, Music Society, Drama Society, Sports clubs, Prefects' Council, and others currently active.*
...
| # | Asset | Owner | Notes | Status |
|---|-------|-------|-------|--------|
| 7.1 | Swimming pool photographs | Media Unit | Interior and exterior views | ⬜ |
| 7.2 | Library / resource centre photographs | Media Unit | Interior showing books and reading areas | ⬜ |
| 7.3 | Science laboratory photographs | Media Unit | At least 2 different labs | ⬜ |
| 7.4 | ICT laboratory photographs | Media Unit | Interior view | ⬜ |
| 7.5 | Sports grounds / playing fields | Media Unit | Wide landscape shot | ⬜ |
| 7.6 | Auditorium or main hall | Media Unit | Interior and stage | ⬜ |
| 7.7 | Classrooms (representative) | Media Unit | At least one interior view | ⬜ |
| 7.8 | Other notable facilities | Media Unit | Canteen, medical room, etc. | ⬜ |
| 7.9 | Swimming pool details and pricing | Administration | Session times, pricing per session/membership | ⬜ |
| 7.10 | Library hours and collection overview | Administration | Brief description of available resources | ⬜ |
| 7.11 | Sports facilities details | Administration | Available sports, booking process | ⬜ |
...
| # | Asset | Owner | Notes | Status |
|---|-------|-------|-------|--------|
| 8.1 | Annual Prize-Giving photographs | Media Unit / Archive | Recent and historical | ⬜ |
| 8.2 | Sports Day / Athletic Meet photographs | Media Unit | Action and group shots | ⬜ |
| 8.3 | Cultural events / concert photographs | Media Unit | Performances and audience | ⬜ |
| 8.4 | Science / ICT exhibition photographs | Media Unit | Displays and presentations | ⬜ |
| 8.5 | School trips and outdoor activities | Media Unit | Group photos with staff | ⬜ |
| 8.6 | Historical photographs (archive) | Alumni / Senior Students | Collected with consent | ⬜ |
| 8.7 | School building and grounds (various) | Media Unit | Multiple angles and lighting conditions | ⬜ |

*Target: minimum 40 gallery images at launch.*
...
| # | Asset | Owner | Notes | Status |
|---|-------|-------|-------|--------|
| 9.1 | Official school address | Administration | Full mailing address | ⬜ |
| 9.2 | Main telephone number(s) | Administration | Including STD code | ⬜ |
| 9.3 | Official school email address(es) | Administration | Principal's office, admissions, general inquiries | ⬜ |
| 9.4 | Office hours | Administration | Days and hours open to visitors | ⬜ |
| 9.5 | Map / location pin | KITS | Google Maps coordinates | 🟡 |

---

## Section 10: School Branding Assets

| # | Asset | Owner | Notes | Status |
|---|-------|-------|-------|--------|
| 10.1 | School crest / emblem (vector or high-res PNG) | Administration | For navigation, footer, social media | ⬜ |
| 10.2 | School crest on white background | Administration | For print and documents | ⬜ |
| 10.3 | School flag or banner photograph | Media Unit | High-resolution | ⬜ |
| 10.4 | Official school colours confirmation | Administration | Confirm exact shades of school green and gold | 🟡 |
...
| 6. Societies | 6 per society | Teachers-in-Charge + Media Unit | 6 per society |
| 7. Facilities | 11 | Administration + Media Unit | 11 |
| 8. Gallery | 7 | Media Unit + Alumni | 7 |
| 9. Contact | 5 | Administration + KITS | 4 |
| 10. Branding | 4 | Administration + Media Unit | 3 |
| **Total (excl. societies)** | **68** | | **66** |

*This inventory will be updated as assets are collected during September – October 2026.*
...
*Nexus – C.W.W. Kannangara Central College – "Wisdom is All Wealth" – Est. 1873*