...
A perfect CMS with no assigned content owners produces a dead website within six months. This document defines who is responsible for each content type, how often it should be updated, and what the publishing workflow is.

---

## Content Ownership Matrix

| Content Type             | Owner                                                               | Secondary             | Update Frequency           |
| ------------------------ | ------------------------------------------------------------------- | --------------------- | -------------------------- |
| **News & Announcements** | Editorial Team (selected staff + KITS)                              | Staff Advisor         | Minimum 2 articles/month   |
| **Events**               | Society leaders (society events) + Class teachers (academic events) | Event coordinator     | 2 weeks before event       |
| **Gallery**              | Media Unit / Photography Club                                       | School administration | Within 1 week of events    |
| **Examination Results**  | Examinations Office                                                 | Principal             | Within 24 hours of release |
| **Staff Profiles**       | School administration                                               | Human Resources       | When staff join or leave   |
| **Society Information**  | Society Advisors                                                    | Student leaders       | Annually or as needed      |
| **Digital Archive**      | History Committee (senior teachers + OBA)                           | Alumni association    | Ongoing                    |
| **Academic Programs**    | Academic Office                                                     | Section heads         | Annually                   |
| **Facilities**           | School administration                                               | Facilities Manager    | As renovations occur       |
| **Social Media**         | Designated social media editors                                     | Staff Advisor         | Weekly minimum             |
...
| -------------------- | ---------------- | --------------------- |
| News & Announcements | Monthly          | Staff Advisor         |
| Events               | Weekly           | Event coordinator     |
| Gallery              | Monthly          | Media Unit head       |
| Staff Profiles       | Quarterly        | School administration |
| Society Information  | Annually         | Society Advisors      |
| Academic Programs    | Annually         | Academic Office       |
| Facilities           | Annually         | Facilities Manager    |
...
- **Tone:** Formal but welcoming — like a respected headmaster
- **Voice:** Educational, heritage-focused, proud but not arrogant
- **Avoid:** Marketing jargon, excessive exclamation marks, corporate language

### Images

- **Quality:** High-resolution, well-lit, in-focus
- **Content:** Real students and staff (no stock photography)
- **Processing:** No heavy filters or artificial HDR

### Accessibility

- All images must have alt text
- All articles must have a clear structure (headings, paragraphs)
