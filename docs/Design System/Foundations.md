# Nexus Design System – Foundations
...
2. [Thematic Concept – Stepping Into the Forest](#2-thematic-concept--stepping-into-the-forest)
3. [Theme Architecture](#3-theme-architecture)
4. [Token Naming Convention](#4-token-naming-convention)
5. [Colour System](#5-colour-system)
6. [Typography](#6-typography)
7. [Responsive Typography Rules](#7-responsive-typography-rules)
8. [Internationalisation Rules](#8-internationalisation-rules)
9. [Spacing & Layout Grid](#9-spacing--layout-grid)
10. [Sizing & Container Tokens](#10-sizing--container-tokens)
11. [Border Radius](#11-border-radius)
12. [Elevation & Shadows](#12-elevation--shadows)
13. [Glass System & Tokens](#13-glass-system--tokens)
14. [Z-Index Layering](#14-z-index-layering)
15. [Icon System](#15-icon-system)
16. [Touch Target Specification](#16-touch-target-specification)
17. [Motion & Animation](#17-motion--animation)
18. [Image Standards](#18-image-standards)
19. [Empty, Error & Loading Philosophy](#19-empty-error--loading-philosophy)
20. [Accessibility Standards](#20-accessibility-standards)
21. [Component States & Tokens](#21-component-states--tokens)
22. [Forms Specification](#22-forms-specification)
23. [Data Display Patterns](#23-data-display-patterns)
24. [Content Guidelines](#24-content-guidelines)
25. [SEO & Metadata Standards](#25-seo--metadata-standards)
26. [Security & Privacy Guidelines](#26-security--privacy-guidelines)
27. [Performance Rules](#27-performance-rules)
28. [Architecture Boundary & Ownership](#28-architecture-boundary--ownership)
29. [Component Inventory](#29-component-inventory)
30. [Browser Support](#30-browser-support)
31. [System Integrity Rules](#31-system-integrity-rules)
32. [Governance & Versioning](#32-governance--versioning)
...
| **Component Tokens** | Component‑specific overrides (used sparingly) | See [Component State Tokens](#21-component-states--tokens) |
...
`{category}{subcategory}{variant}` (kebab‑case for CSS, camelCase for JS)

**Examples:**

| Category | Token CSS | Token Tailwind |
|----------|-----------|----------------|
...
**Rule:** New tokens must follow this pattern. No ad‑hoc token names.
...
Actual colour values are listed in the **[Tokens Reference](./Tokens%20Reference.md)**.
...
Complete type scale (sizes, line heights, letter spacing) in **[Tokens Reference](./Tokens%20Reference.md)**.
...
| **Body text minimum** | Equivalent to `1rem` (16px). `text-body` is `1.05rem`. |
| **Sinhala body line‑height** | Must be `leading-relaxed` (1.8) – see [Tokens Reference](./Tokens%20Reference.md#line-heights). |
...
| Rule | Implementation |
|------|----------------|
| **Sinhala line‑height** | `leading-relaxed` (1.8) for body text. |
...
Complete spacing list in **[Tokens Reference](./Tokens%20Reference.md)**.
...
| Token | Usage |
|-------|-------|
| `size-11` | Minimum touch target (44px) |
| `max-w-prose` | Reading width (680px) |
| `max-w-content` | Default container (960px) |
| `max-w-wide` | Large container (1200px) |

Complete sizing tokens in **[Tokens Reference](./Tokens%20Reference.md)**.
...
| Token | Usage |
|-------|-------|
| `rounded-sm` | Buttons, cards (10px) |
| `rounded-md` | Modals, large cards (15px) |
| `rounded-lg` | Hero containers (20px) |
| `rounded-full` | Avatars, badges |

Values are intentionally larger to support the soft‑glass aesthetic.
...
Complete shadow tokens in **[Tokens Reference](./Tokens%20Reference.md)**.
...
These tokens are defined in **[Tokens Reference](./Tokens%20Reference.md)**.  
...
**All interactive elements must have a minimum hit area of 44×44px.**

| Element | Requirement |
|---------|-------------|
| Buttons | Minimum 44×44px. Use `size="md"` (maps to `size-11` = 44px) or add padding. |
...
All durations, easings, and transform scales must use tokens (see **[Tokens Reference](./Tokens%20Reference.md)**).  
...
Every interactive component must define and use the following state tokens (see **[Tokens Reference](./Tokens%20Reference.md)** for values):
...
| Element | Standard |
|---------|----------|
| **Inputs, Selects, Textareas** | Use `input-base` (shared styles) and `border-error` for errors. |
...
| **Layout** | Use `FormFieldGroup` and `FormSectionWrapper`. |
...
All approved components are in `@nexus/ui`. Full catalogue in [`Components.md`](./Components.md) (or Storybook).
...
- **[Design Tokens Reference](./Tokens%20Reference.md)** – Complete listing of all token values.
- **[Components](./Components.md)** – Full component catalogue and usage.
- **[Page Specifications](./Page%20Specifications.md)** – Page layouts and content requirements.
