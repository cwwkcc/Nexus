# Nexus Design System – Tokens Reference

**C.W.W. Kannangara Central College, Mathugama**  
*Maintained by Kannangara ICT Society (KITS)*

This document lists **every design token** in the system. Tokens are the single source of truth for all visual styling.
...
4. [Sizing Tokens](#4-sizing-tokens)
5. [Container Max‑Width Tokens](#5-container-max-width-tokens)
6. [Border Width Tokens](#6-border-width-tokens)
7. [Border Radius Tokens](#7-border-radius-tokens)
8. [Shadow Tokens](#8-shadow-tokens)
9. [Glass Tokens](#9-glass-tokens)
10. [Z‑Index Tokens](#10-z-index-tokens)
11. [Opacity Tokens](#11-opacity-tokens)
12. [Blur Tokens](#12-blur-tokens)
13. [Aspect Ratio Tokens](#13-aspect-ratio-tokens)
14. [Transform Scale Tokens](#14-transform-scale-tokens)
15. [Motion Tokens](#15-motion-tokens)
    - Duration
    - Easing
16. [Breakpoint Tokens](#16-breakpoint-tokens)
17. [Icon Size Tokens](#17-icon-size-tokens)
18. [Focus Ring Tokens](#18-focus-ring-tokens)
